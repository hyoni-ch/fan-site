...
function Goods() {
  ...
  const [activeSort, setActiveSort] = useState<"last" | "asc" | "desc">("last");
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
            ...
            >
              <Button
                ...
                sx={{
                  color: activeSort === "last" ? "black" : "gray",
                }}
                startIcon={activeSort === "last" ? <CheckIcon /> : null}
              >
                최신등록순
              </Button>
              <Button
                ...
                sx={{
                  color: activeSort === "asc" ? "black" : "gray",
                }}
                startIcon={activeSort === "asc" ? <CheckIcon /> : null}
              >
                낮은가격순
              </Button>
              <Button
                ...
                sx={{
                  color: activeSort === "desc" ? "black" : "gray",
                }}
                startIcon={activeSort === "desc" ? <CheckIcon /> : null}
              >
                높은가격순
              </Button>
            </ButtonGroup>
